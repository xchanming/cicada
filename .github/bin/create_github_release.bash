...
# already available.
#
# Can be removed once https://gitlab.xchanming.com/infrastructure/docker-base/-/merge_requests/8 is merged.
...
REPOSITORY_API_URL='https://api.github.com/repos/cicada/cicada'
