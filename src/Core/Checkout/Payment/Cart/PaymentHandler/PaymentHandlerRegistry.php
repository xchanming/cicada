...
class PaymentHandlerRegistry
{
    ...
    public function __construct(
        ...
        foreach (\array_keys($syncHandlers->getProvidedServices()) as $serviceId) {
            if (isset($this->handlers[(string) $serviceId])) {
                continue;
            }
            Feature::triggerDeprecationOrThrow(
                'v6.7.0.0',
                \sprintf('The tag `cicada.payment.method.sync` is deprecated for service %s and will be removed in 6.7.0. Use `cicada.payment.method` instead.', $serviceId),
            );
        ...
        foreach (\array_keys($asyncHandlers->getProvidedServices()) as $serviceId) {
            ...
            Feature::triggerDeprecationOrThrow(
                'v6.7.0.0',
                \sprintf('The tag `cicada.payment.method.async` is deprecated for service %s and will be removed in 6.7.0. Use `cicada.payment.method` instead.', $serviceId),
            );
        ...
        foreach (\array_keys($preparedHandlers->getProvidedServices()) as $serviceId) {
            ...
            Feature::triggerDeprecationOrThrow(
                'v6.7.0.0',
                \sprintf('The tag `cicada.payment.method.prepared` is deprecated for service %s and will be removed in 6.7.0. Use `cicada.payment.method` instead.', $serviceId),
            );
        ...
        foreach (\array_keys($refundHandlers->getProvidedServices()) as $serviceId) {
            ...
            Feature::triggerDeprecationOrThrow(
                'v6.7.0.0',
                \sprintf('The tag `cicada.payment.method.refund` is deprecated for service %s and will be removed in 6.7.0. Use `cicada.payment.method` instead.', $serviceId),
            );
        ...
        foreach (\array_keys($recurringHandlers->getProvidedServices()) as $serviceId) {
            ...
            Feature::triggerDeprecationOrThrow(
                'v6.7.0.0',
                \sprintf('The tag `cicada.payment.method.recurring` is deprecated for service %s and will be removed in 6.7.0. Use `cicada.payment.method` instead.', $serviceId),
            );
