...
const { mapGetters } = Cicada.Component.getComponentHelper();
...
export default {
    ...
    methods: {
        ...
        openDocument(documentId, documentDeepLink) {
            this.documentService.getDocument(documentId, documentDeepLink, Cicada.Context.api, true).then((response) => {
                if (response.data) {
        ...
        async onCreateDocument(params, additionalAction, referencedDocumentId = null, file = null) {
            ...
            try {
                ...
                if (params.documentMediaFileId) {
                    const documentData = await this.documentRepository.get(documentId, Cicada.Context.api);
                ...
                if (additionalAction === 'download') {
                    ...
                    this.documentRepository.get(documentId, Cicada.Context.api, criteria).then((documentData) => {
                        if (!documentData) {
                            return;
                        }
