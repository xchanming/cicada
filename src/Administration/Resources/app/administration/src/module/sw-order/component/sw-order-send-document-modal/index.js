...
export default {
    ...
    methods: {
        ...
        setEmailTemplateAccordingToDocumentType() {
            ...
            this.mailTemplateRepository.search(this.mailTemplateCriteria, Cicada.Context.api).then((result) => {
        ...
        onSendDocument() {
            ...
            this.mailTemplateRepository
                .get(this.mailTemplateId, Cicada.Context.api, this.mailTemplateSendCriteria)
                .then((mailTemplate) => {
                    this.mailService
                        .sendMailTemplate(
                            this.recipient,
