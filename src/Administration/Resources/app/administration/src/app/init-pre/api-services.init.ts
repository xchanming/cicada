...
export default async function initializeApiServices() {
    const apiServices = Cicada._private.ApiServices();
    ...
    if (window._features_.ADMIN_VITE) {
        ...
        for (const ApiServicePromise of apiServices) {
            ...
            const service = new ApiService(initContainer.httpClient, Cicada.Service('loginService'));
            ...
            Cicada.Application.addServiceProvider(serviceName, () => {
