...
import type { extension } from '@cicada-ag/meteor-admin-sdk/es/_internals/privileges';
import type { extensions } from '@cicada-ag/meteor-admin-sdk/es/channel';
import { setExtensions } from '@cicada-ag/meteor-admin-sdk/es/channel';
