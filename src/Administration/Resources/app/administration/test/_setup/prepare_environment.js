...
// Add all directives
const directiveRegistry = Cicada.Directive.getDirectiveRegistry();
...
// Add all filters
const filterRegistry = Cicada.Filter.getRegistry();
...
// Add services
Cicada.Service().register('acl', () => aclService);
Cicada.Service().register('feature', () => feature);
Cicada.Feature = Cicada.Service('feature');
Cicada.Service().register('repositoryFactory', () => repositoryFactory);

// Provide all services
Cicada.Service().list().forEach(serviceKey => {
    config.global.provide[serviceKey] = Cicada.Service(serviceKey);
});

// Set important functions for Cicada Core
...
Cicada.State.commit('context/setApiApiPath', '/api');
Cicada.State.commit('context/setApiApiResourcePath', '/api/v3');
Cicada.State.commit('context/setApiAssetsPath', '');
Cicada.State.commit('context/setApiLanguageId', '2fbb5fe2e29a4d70aa5854ce7ce3e20b');
Cicada.State.commit('context/setApiInheritance', false);
Cicada.State.commit('context/setApiSystemLanguageId', '2fbb5fe2e29a4d70aa5854ce7ce3e20b');
Cicada.State.commit('context/setApiLiveVersionId', '0fa91ce3e96a4bc2be4bd9ce752c3425');
Cicada.Context.api.authToken = {
