...
use Cicada\WebInstaller\Controller\InstallController;
...
class InstallControllerTest extends TestCase
{
    public function testStartPage(): void
    {
        ...
        $recovery->method('getCicadaLocation')->willReturn('asd');
    ...
    public function testInstall(): void
    {
        ...
        $recovery = $this->createMock(RecoveryManager::class);
        $recovery->method('getCicadaLocation')->willReturn('location');
        ...
        $request->query->set('cicadaVersion', '6.4.10.0');
