...
use Cicada\WebInstaller\Controller\PhpConfigController;
...
class PhpConfigControllerTest extends TestCase
{
    ...
    public function testSetConfigOnInstall(): void
    {
        ...
        $recoveryManager->method('getCicadaLocation')->willThrowException(new \RuntimeException('cannot find cicada'));
