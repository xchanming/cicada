...
namespace Cicada\WebInstaller\Tests;

use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\TestCase;
use Cicada\WebInstaller\Kernel;
...
class KernelTest extends TestCase
{
    ...
    public function testCacheDir(): void
    {
        ...
        static::assertSame(sys_get_temp_dir() . '/cicada-recovery@git_commit_short@' . $kernelPath . '/', $kernel->getCacheDir());
        static::assertSame(sys_get_temp_dir() . '/cicada-recovery@git_commit_short@' . $kernelPath . '/', $kernel->getLogDir());
    }
