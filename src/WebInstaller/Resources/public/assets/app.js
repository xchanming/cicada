...
if (installButton) {
    installButton.onclick = async function () {
        ...
        const cicadaVersion = document.getElementById('cicadaVersion');

        const installResponse = await fetch(`${baseUrl}/install/_run?cicadaVersion=` + cicadaVersion.value, {method: 'POST'});
...
if (updateButton) {
    updateButton.onclick = async function () {
        ...
        const updateRun = await fetch(`${baseUrl}/update/_run?cicadaVersion=${cicadaVersion.value}`, {method: 'POST'});
