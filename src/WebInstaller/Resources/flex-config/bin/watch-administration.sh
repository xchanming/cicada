...
if [ ! -d vendor/cicada/administration/Resources/app/administration/node_modules ]; then
    npm install --prefix vendor/cicada/administration/Resources/app/administration/
fi
...
npm run --prefix vendor/cicada/administration/Resources/app/administration/ dev
