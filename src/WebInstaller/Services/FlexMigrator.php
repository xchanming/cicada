...
# With Cicada 6.4.17.0 the MAILER_DSN variable will be used in this template instead of MAILER_URL
...
EOT;
    ...
    public function patchRootComposerJson(string $projectDir): void
    {
        ...
        // Remove old recovery
        unset($composerJson['require']['cicada/recovery']);
        ...
        $composerJson['extra']['symfony'] = [
            'allow-contrib' => true,
            'endpoint' => [
                'https://raw.githubusercontent.com/cicada/recipes/flex/main/index.json',
                'flex://defaults',
            ],
        ];
