...
use Cicada\Storefront\Theme\Aggregate\ThemeTranslationEntity;
...
class ThemeLifecycleServiceTest extends TestCase
{
    ...
    public function testItWontThrowIfMediaHasRestrictDeleteAssociation(): void
    {
        ...
        $cicadaLogoId = $this->getMedia('cicada_logo');
        $this->createCmsPage($cicadaLogoId->getId());

        $this->themeLifecycleService->refreshTheme($bundle, $this->context);

        // assert that the file cicada_logo was not deleted and is assigned to same media entity as before
        static::assertEquals($cicadaLogoId, $this->getMedia('cicada_logo'));
    }
    ...
    public function testItDontRenamesThemeMediaIfItExistsBeforeAndIsSame(): void
    {
        ...
        static::assertInstanceOf(MediaCollection::class, $themeEntity->getMedia());
        $renamedCicadaLogoId = $this->getMedia('cicada_logo');
        static::assertNotNull($themeEntity->getMedia()->get($renamedCicadaLogoId->getId()));
    }
    ...
    public function testItRenamesThemeMediaIfItExistsBefore(): void
    {
        ...
        static::assertInstanceOf(MediaCollection::class, $themeEntity->getMedia());
        $renamedCicadaLogoId = $this->getMedia('cicada_logo_pink2');
        static::assertNotNull($themeEntity->getMedia()->get($renamedCicadaLogoId->getId()));
    }
    ...
    public function testItIgnoresMediaFieldsWithoutValue(): void
    {
        ...
        static::assertInstanceOf(MediaCollection::class, $themeEntity->getMedia());
        $this->hasNoMedia('cicada_logo_pink2');
    }
