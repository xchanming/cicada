...
class ThemeTest extends TestCase
{
    ...
    public function testThemeServiceUpdate(): void
    {
        ...
        try {
            ...
            if ($e->getMessage() !== 'Unable to compile the theme "Cicada default theme". Files could not be resolved with error: Unable to compile the theme "Storefront". Unable to load file "Resources/app/storefront/dist/storefront/storefront.js". Did you forget to build the theme? Try running ./bin/build-storefront.sh') {
                throw $e;
            }
        }
