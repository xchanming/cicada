...
class MediaUploadControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        \copy(self::TEST_IMAGE, static::getContainer()->getParameter('kernel.project_dir') . '/public/media/cicada-logo.png');
    }

    protected function tearDown(): void
    {
        \unlink(static::getContainer()->getParameter('kernel.project_dir') . '/public/media/cicada-logo.png');
    ...
    public function testUploadFromURL(): void
    {
        ...
        $baseUrl = EnvironmentHelper::getVariable('APP_URL') . '/media/cicada-logo.png';
