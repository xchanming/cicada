...
use Cicada\Core\Content\Media\Cms\Type\ImageSliderTypeDataResolver;
...
class ImageSliderTypeDataResolverTest extends TestCase
{
    ...
    public function testEnrichWithDefaultConfig(): void
    {
        ...
        $medias = [
            ...
            ['fileName' => 'bundles/core/assets/default/cms/cicada.jpg'],
        ];
        ...
        static::assertEquals('cicada', $secondSliderItemMedia->getFileName());
