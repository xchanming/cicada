...
class FileFetcherTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        \copy(self::TEST_IMAGE, $projectDir . '/public/media/cicada-logo.png');
    }

    protected function tearDown(): void
    {
        $projectDir = (new TestBootstrapper())->getProjectDir();
        \unlink($projectDir . '/public/media/cicada-logo.png');
    ...
    {
        $url = EnvironmentHelper::getVariable('APP_URL') . '/media/cicada-logo.png';
    ...
    {
        $invalidUrl = 'ssh://de.xchanming.com/press/company/Cicada_Jamaica.jpg';
        $this->expectException(MediaException::class);
