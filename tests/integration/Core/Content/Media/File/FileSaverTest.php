...
use Cicada\Core\Content\Media\DataAbstractionLayer\MediaIndexer;
...
class FileSaverTest extends TestCase
{
    ...
    public function testRenameMediaMakesRollbackOnFailure(): void
    {
        ...
        $allowed = static::getContainer()->getParameter('cicada.filesystem.allowed_extensions');
        $allowedPrivate = static::getContainer()->getParameter('cicada.filesystem.private_allowed_extensions');
