...
use Cicada\Core\Content\Test\ImportExport\StockSubscriber;
use Cicada\Core\Content\Test\ImportExport\TestSubscriber;
...
SWTEST;1;' . $productName . ';9.35;10;0c17372fe6aa46059a97fc28b40f46c4;7;7%%;%s',
    ...
    public function testCustomersCsv(): void
    {
        ...
        static::assertSame('cicada AG', $customerWithMultipleAddresses->getDefaultBillingAddress()->getCompany());
        ...
        static::assertSame('cicada AG', $customerWithUpdatedAddresses->getDefaultShippingAddress()->getCompany());
