...
use Cicada\Core\Content\Product\DataAbstractionLayer\CheapestPriceUpdater;
...
use Cicada\Core\Content\Product\DataAbstractionLayer\RatingAverageUpdater;
...
use Cicada\Core\Content\Product\DataAbstractionLayer\VariantListingUpdater;
...
class ProductIndexerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->messageBus = self::getContainer()->get('messenger.bus.cicada');
