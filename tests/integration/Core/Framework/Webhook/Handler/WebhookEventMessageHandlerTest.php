...
use Cicada\Core\Framework\Webhook\EventLog\WebhookEventLogEntity;
use Cicada\Core\Framework\Webhook\Handler\WebhookEventMessageHandler;
...
class WebhookEventMessageHandlerTest extends TestCase
{
    ...
    public function testSendSuccessful(): void
    {
        ...
        static::assertEquals($request->getHeaderLine(AuthMiddleware::CICADA_USER_LANGUAGE), 'en-GB');
        static::assertEquals($request->getHeaderLine(AuthMiddleware::CICADA_CONTEXT_LANGUAGE), Defaults::LANGUAGE_SYSTEM);
