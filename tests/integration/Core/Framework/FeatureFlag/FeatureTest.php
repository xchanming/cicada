...
use Cicada\Core\Framework\Adapter\Twig\Extension\FeatureFlagExtension;
...
class FeatureTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        Feature::registerFeatures(static::getContainer()->getParameter('cicada.feature.flags'));
    }
    ...
    public function testConfigGetAllReturnsAllAndTracksState(): void
    {
        ...
        $featureFlags = array_keys(static::getContainer()->getParameter('cicada.feature.flags'));
