...
use Cicada\Core\Framework\Test\DataAbstractionLayer\Search\TestAggregation;
use Cicada\Core\Framework\Test\DataAbstractionLayer\Search\Util\DateHistogramCase;
...
class EntityAggregatorTest extends TestCase
{
    ...
    public static function dateHistogramProvider(): array
    {
        return array_filter([
            ...
            EnvironmentHelper::getVariable('CICADA_DBAL_TIMEZONE_SUPPORT_ENABLED', 0) ? [
                new DateHistogramCase(DateHistogramAggregation::PER_DAY, [
                    '2019-01-01 00:00:00' => 2,
                    '2019-06-15 00:00:00' => 1,
                    '2020-09-30 00:00:00' => 1,
    ...
    public function testAggregateNonExistingShouldFail(): void
    {
        ...
        $this->expectExceptionMessage('Aggregation of type Cicada\Core\Framework\Test\DataAbstractionLayer\Search\TestAggregation not supported');
