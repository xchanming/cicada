...
use Cicada\Core\Framework\Test\DataAbstractionLayer\Write\NonUuidFkField\NonUuidFkFieldSerializer;
use Cicada\Core\Framework\Test\DataAbstractionLayer\Write\NonUuidFkField\TestEntityOneDefinition;
use Cicada\Core\Framework\Test\DataAbstractionLayer\Write\NonUuidFkField\TestEntityTwoDefinition;
...
class EntityWriterTest extends TestCase
{
        ...
        $this->getWriter()->insert(
            ...
            [
                [
                    ...
                    'tax' => ['name' => 'test', 'taxRate' => 5],
                    'manufacturer' => ['id' => Uuid::randomHex(), 'link' => 'https://xchanming.com', 'name' => 'cicada AG'],
                    'mode' => 0,
                    'lastStock' => true,
                    'crossbundlelook' => 1,
                    'notification' => true,
    ...
    public function testUpdate(): void
    {
        ...
        static::assertSame('http://www.xchanming.com', $productManufacturer['link']);
    }
