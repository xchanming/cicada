...
use Cicada\Core\Framework\Test\Script\Execution\DeprecatedTestHook;
use Cicada\Core\Framework\Test\Script\Execution\FunctionWillBeRequiredTestHook;
use Cicada\Core\Framework\Test\Script\Execution\StoppableTestHook;
...
class ScriptExecutorTest extends TestCase
{
    ...
    public function testExecuteGetCicadaVersion(): void
    {
        $this->testExecute(
            ['cicada-version-case'],
            ['version' => static::getContainer()->getParameter('kernel.cicada_version'), 'version_compare' => true]
        );
    }
