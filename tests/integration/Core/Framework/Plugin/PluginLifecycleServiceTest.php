...
class PluginLifecycleServiceTest extends TestCase
{
    ...
    public function testRemoveMigrationsCannotRemoveCicadaMigrations(): void
    {
        $this->removeMigrationsCannotRemoveCicadaMigrations($this->context);
    }
    ...
    public function testRemoveMigrationsCannotRemoveCicadaMigrationsWithNonStandardLanguage(): void
    {
        $this->removeMigrationsCannotRemoveCicadaMigrations($this->createNonStandardLanguageContext());
    }
    ...
    private function removeMigrationsCannotRemoveCicadaMigrations(Context $context): void
    {
        $this->pluginService->refreshPlugins($context, new NullIO());
        ...
        $_SERVER['FAKE_MIGRATION_NAMESPACE'] = 'Cicada\\Core';
