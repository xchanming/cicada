...
class FlowActionTest extends TestCase
{
    ...
    public function testCreateFromXmlFlowActionConfigInputFieldTypeInvalid(): void
    {
        ...
        $this->expectExceptionMessage('[ERROR 1840] Element \'input-field\', attribute \'type\': [facet \'enumeration\'] The value \'cicada\' is not an element of the set {\'text\', \'textarea\', \'text-editor\', \'url\', \'password\', \'int\', \'float\', \'bool\', \'checkbox\', \'datetime\', \'date\', \'time\', \'colorpicker\', \'single-select\', \'multi-select\'}.');
