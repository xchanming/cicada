...
use Cicada\Core\Framework\App\Command\RefreshAppCommand;
...
class RefreshAppCommandTest extends TestCase
{
    ...
    public function testRefreshWithoutPermissions(): void
    {
        ...
        // content
        static::assertMatchesRegularExpression('/.*withoutPermissions\s+Swag App Test\s+1.0.0\s+cicada AG\s+\n.*/', $display);
    }
    ...
    public function testRefreshWithForce(): void
    {
        ...
        static::assertMatchesRegularExpression('/.*App\s+Label\s+Version\s+Author\s+\n.*/', $display);
        // content
        static::assertMatchesRegularExpression('/.*withPermissions\s+Swag App Test\s+1.0.0\s+cicada AG\s+\n.*/', $display);
    }
    ...
    public function testRefreshWithAllowedHostsOnInstall(): void
    {
        ...
        static::assertMatchesRegularExpression('/.*App\s+Label\s+Version\s+Author\s+\n.*/', $display);
        // content app list
        static::assertMatchesRegularExpression('/.*withAllowedHosts\s+Swag App Test\s+1.0.0\s+cicada AG\s+\n.*/', $display);
    }
    ...
    public function testRefreshInvalidAppWithNoValidate(): void
    {
        ...
        // content app list
        static::assertMatchesRegularExpression('/.*validationFailures\s+Swag App Test\s+1.0.0\s+cicada AG\s+\n.*/', $commandTester->getDisplay());
    }
