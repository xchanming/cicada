...
use Cicada\Core\System\CustomEntity\CustomEntityEntity;
use Cicada\Core\System\CustomField\Aggregate\CustomFieldSet\CustomFieldSetCollection;
use Cicada\Core\System\CustomField\Aggregate\CustomFieldSetRelation\CustomFieldSetRelationEntity;
...
- Order value',
    ...
    public function testInstallSavesConfig(): void
    {
        ...
        static::assertSame([
            'withConfig.config.email' => 'no-reply@cicada.de',
