...
class AppRegistrationServiceTest extends TestCase
{
    ...
    public function testRegisterPrivateApp(): void
    {
        ...
        static::assertNotEmpty($registrationRequest->getHeaderLine(AuthMiddleware::CICADA_USER_LANGUAGE));
        static::assertNotEmpty($registrationRequest->getHeaderLine(AuthMiddleware::CICADA_CONTEXT_LANGUAGE));
        ...
        static::assertSame(
            ...
            $confirmationReq->getHeaderLine('cicada-shop-signature')
        );
    ...
    public function testRegistrationFailsIfAppUrlChangeWasDetected(): void
    {
        ...
        $registrator = new AppRegistrationService(
            $handshakeFactory,
            static::getContainer()->get('cicada.app_system.guzzle'),
    ...
    public function testRegisterStoreApp(): void
    {
        ...
        static::assertNotEmpty($confirmationRequest->getHeaderLine(AuthMiddleware::CICADA_USER_LANGUAGE));
        static::assertNotEmpty($confirmationRequest->getHeaderLine(AuthMiddleware::CICADA_CONTEXT_LANGUAGE));
    }
    ...
    private function assertRequestIsSigned(RequestInterface $registrationRequest, string $secret): void
    {
        static::assertSame(
            ...
            $registrationRequest->getHeaderLine('cicada-app-signature')
        );
    }
