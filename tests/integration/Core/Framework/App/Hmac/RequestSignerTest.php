...
class RequestSignerTest extends TestCase
{
    ...
    public function testSignHeaderAddedRequest(): void
    {
        ...
        static::assertTrue($request->hasHeader(RequestSigner::CICADA_SHOP_SIGNATURE));

        static::assertSame($hashExpected, $request->getHeader(RequestSigner::CICADA_SHOP_SIGNATURE)[0]);
    }
    ...
    public function testSignHeaderWithoutAddedMethodGet(): void
    {
        ...
        static::assertFalse($request->hasHeader(RequestSigner::CICADA_SHOP_SIGNATURE));
    }
    ...
    public function testIsResponseAuthenticRequired(): void
    {
        ...
        $responseHeaders = [
            RequestSigner::CICADA_APP_SIGNATURE => $signature,
        ];
