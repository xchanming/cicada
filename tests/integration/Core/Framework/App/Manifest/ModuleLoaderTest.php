...
class ModuleLoaderTest extends TestCase
{
    ...
    private function validateSource(string $givenSource, string $urlPath, string $secret): void
    {
        ...
        static::assertSame(static::getContainer()->getParameter('kernel.cicada_version'), $query['sw-version']);
        ...
        $signedQuery = str_replace('&cicada-shop-signature=' . $signature, '', $queryString);
