...
use Cicada\Core\DevOps\StaticAnalyze\PHPStan\Rules\Tests\NoAssertsOnObjectsRule;
...
class NoAssertsOnObjectsRuleTest extends RuleTestCase
{
    ...
    {
        $this->analyse([__DIR__ . '/../data/NoAssertOnResponseObject/cicada-unit-test.php'], [
            [
