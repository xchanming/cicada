...
class DomainExceptionRuleTest extends RuleTestCase
{
    ...
    public function testRule(): void
    {
        $this->analyse([__DIR__ . '/data/DomainExceptionRule/DomainExceptionViolations.php'], [
            [
                'Throwing new exceptions within classes are not allowed. Please use domain exception pattern. See https://github.com/cicada/platform/blob/v6.4.20.0/adr/2022-02-24-domain-exceptions.md',
                9,
            ],
        ]);
