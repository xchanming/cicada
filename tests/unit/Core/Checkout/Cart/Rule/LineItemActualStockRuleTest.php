...
use Cicada\Core\Checkout\Cart\Rule\LineItemActualStockRule;
...
class LineItemActualStockRuleTest extends TestCase
{
    ...
    public function testMatchWithoutStockExpectException(): void
    {
        ...
        $this->expectExceptionMessage('Unsupported value of type NULL in Cicada\Core\Checkout\Cart\Rule\LineItemActualStockRule');
