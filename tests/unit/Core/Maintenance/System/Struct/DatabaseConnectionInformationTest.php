...
namespace Cicada\Tests\Unit\Core\Maintenance\System\Struct;
...
class DatabaseConnectionInformationTest extends TestCase
{
    ...
    public function testValidInformation(): void
    {
        ...
        static::assertSame('cicada', $info->getDatabaseName());
        ...
        static::assertSame([
            'url' => 'mysql://root:root@localhost:3306/cicada',
            'charset' => 'utf8mb4',
            'driverOptions' => [
    ...
    public function testAssignWithRequestStringValues(): void
    {
        ...
        static::assertSame([
            'url' => 'mysql://root:root@localhost:3307/cicada',
            'charset' => 'utf8mb4',
            'driverOptions' => [
                \PDO::ATTR_STRINGIFY_FETCHES => true,
                \PDO::MYSQL_ATTR_SSL_VERIFY_SERVER_CERT => false,
    ...
    public static function dsnProvider(): \Generator
    {
        yield 'with database' => [
            ...
            false,
            'mysql://root:root@localhost:3306/cicada',
        ];
        ...
        yield 'without password' => [
            ...
            false,
            'mysql://root@localhost:3306/cicada',
        ];
        ...
        yield 'special chars in password' => [
            ...
            false,
            'mysql://root:ultra%3Fsecure%23@mysql:3306/cicada',
        ];
    }
    ...
    public static function validEnvProvider(): \Generator
    {
        yield 'only database' => [
            [
                'DATABASE_URL' => 'mysql://root:root@localhost:3306/cicada',
            ],
            (new DatabaseConnectionInformation())->assign([
                'hostname' => 'localhost',
                'port' => 3306,
        ...
        yield 'without password' => [
            [
                'DATABASE_URL' => 'mysql://root@localhost:3306/cicada',
            ],
            (new DatabaseConnectionInformation())->assign([
                'hostname' => 'localhost',
                'port' => 3306,
        ...
        yield 'without port' => [
            [
                'DATABASE_URL' => 'mysql://localhost/cicada',
            ],
            (new DatabaseConnectionInformation())->assign([
                'hostname' => 'localhost',
                'port' => 3306,
        ...
        yield 'special chars in password' => [
            [
                'DATABASE_URL' => 'mysql://root:ultra%3Fsecure%23@mysql:3306/cicada',
            ],
            (new DatabaseConnectionInformation())->assign([
                'hostname' => 'mysql',
                'port' => 3306,
