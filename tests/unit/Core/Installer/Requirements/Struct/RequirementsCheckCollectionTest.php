...
class RequirementsCheckCollectionTest extends TestCase
{
    public function testGetExpectedClass(): void
    {
        ...
        static::expectExceptionMessage('Expected collection element of type Cicada\Core\Installer\Requirements\Struct\RequirementCheck got Cicada\Core\Content\Product\ProductEntity');
