...
class ServiceExceptionTest extends TestCase
{
    ...
    public function testUpdateRequiresAdminApiSource(): void
    {
        ...
        static::assertEquals('Updating a service requires Cicada\Core\Framework\Api\Context\AdminApiSource, but got Cicada\Core\Framework\Api\Context\ShopApiSource', $e->getMessage());
    }
