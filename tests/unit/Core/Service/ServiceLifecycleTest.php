...
use Cicada\Core\Service\AppInfo;
...
class ServiceLifecycleTest extends TestCase
{
    ...
    public function testInstallLogsErrorIfAppCannotBeInstalled(): void
    {
        ...
        $this->logger
            ->expects(static::once())
            ->method('debug')
            ->with('Cannot install service "MyCoolService" because of error: "App MyCoolService is not compatible with this Cicada version"');
    ...
    public function testUpdateLogsErrorIfAppCannotBeUpdated(): void
    {
        ...
        $this->logger
            ->expects(static::once())
            ->method('debug')
            ->with('Cannot update service "MyCoolService" because of error: "App MyCoolService is not compatible with this Cicada version"');
...
<manifest xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/cicada-ag/platform/trunk/src/Core/Framework/App/Manifest/Schema/manifest-2.0.xsd">
    <meta>
