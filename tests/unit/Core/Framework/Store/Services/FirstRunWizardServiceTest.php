...
class FirstRunWizardServiceTest extends TestCase
{
    ...
    public function testSuccessfulFrwLoginStoresFrwUserToken(): void
    {
        ...
        $frwClient->expects(static::once())
            ->method('frwLogin')
            ->with('cicadaId', 'password', $this->context)
    ...
    public function testIdentifiesAndConvertsCurrentLicenseDomains(): void
    {
        ...
        static::assertEquals('cicada.swag', $otherLicenseDomain->getDomain());
    ...
    public function testGetLanguagePlugins(): void
    {
        $languagePlugins = [
            [
                ...
                'localizedInfo' => [
                    'name' => 'Cicada Language Pack',
                    'shortDescription' => 'Cicada Language Pack',
                ],
            ],
        ];
    ...
    public function testGetDemodataPlugins(): void
    {
        $demodataPlugins = [
            [
                'id' => 123456,
                'name' => 'SwagDemodata',
                'label' => 'Cicada Demodata Plugin',
                'iconPath' => 'https://example.com/icon.png',
                'localizedInfo' => [
                    'name' => 'Cicada Demodata Plugin',
                    'shortDescription' => 'Cicada Demodata Plugin',
                ],
            ],
        ];
