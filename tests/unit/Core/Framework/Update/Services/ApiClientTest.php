...
class ApiClientTest extends TestCase
{
    ...
    public function testCheckUsingClient(): void
    {
        $responses = [
            ...
            new MockResponse('{"title": "Cicada", "body": "bla", "date": "2021-09-01", "version": "6.4.8.1", "fixedVulnerabilities": []}', ['Content-Type' => 'application/json']),
        ];
    ...
    public function testMajorUpgrade(): void
    {
        $responses = [
            ...
            new MockResponse('{"title": "Cicada", "body": "bla", "date": "2021-09-01", "version": "6.5.0.0", "fixedVulnerabilities": []}', ['Content-Type' => 'application/json']),
        ];
    ...
    public function testDownloadRecoveryTool(): void
    {
        ...
        static::assertFileExists(__DIR__ . '/public/cicada-installer.phar.php');
