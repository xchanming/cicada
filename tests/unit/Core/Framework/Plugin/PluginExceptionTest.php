...
class PluginExceptionTest extends TestCase
{
    ...
    public function testCannotDeleteCicadaMigrations(): void
    {
        $e = PluginException::cannotDeleteCicadaMigrations();

        static::assertEquals(PluginException::CANNOT_DELETE_CICADA_MIGRATIONS, $e->getErrorCode());
    }
}
