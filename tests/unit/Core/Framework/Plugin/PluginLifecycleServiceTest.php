...
class PluginLifecycleServiceTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->container->setParameter('cicada.deployment.cluster_setup', false);
    ...
    public function testInstallInClusterModeDoesNotTriggerComposer(): void
    {
        ...
        $this->container->setParameter('cicada.deployment.cluster_setup', true);
    ...
    public function testPluginGetPluginInstanceException(): void
    {
        ...
        static::expectException(\RuntimeException::class);
        static::expectExceptionMessage('Cicada\Core\Framework\Plugin in the container should be an instance of Cicada\Core\Framework\Plugin');
