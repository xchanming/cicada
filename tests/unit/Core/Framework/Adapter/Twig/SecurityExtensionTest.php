...
class SecurityExtensionTest extends TestCase
{
    ...
    public static function notAllowedTemplates(): \Generator
    {
        ...
        yield 'map not allowed callback function string' => ['{{ ["a", "b", "c"]|map("\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget::do")|join }}'];

        yield 'map not allowed callback function array' => ['{{ ["a", "b", "c"]|map([\'\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget\', \'do\'])|join }}'];
        ...
        yield 'reduce not allowed callback function string' => ['{{ ["a", "b", "c"]|reduce("\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget::do")|join }}'];

        yield 'reduce not allowed callback function array' => ['{{ ["a", "b", "c"]|reduce([\'\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget\', \'do\'])|join }}'];
        ...
        yield 'filter not allowed callback function string' => ['{{ ["a", "b", "c"]|filter("\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget::do")|join }}'];

        yield 'filter not allowed callback function array' => ['{{ ["a", "b", "c"]|filter([\'\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget\', \'do\'])|join }}'];
        ...
        yield 'sort not allowed callback function string' => ['{{ ["a", "b", "c"]|sort("\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget::do")|join }}'];

        yield 'sort not allowed callback function array' => ['{{ ["a", "b", "c"]|sort([\'\\\\Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGadget\', \'do\'])|join }}'];
    ...
    public function testMapWithAllowedClosure(): void
    {
        static::assertSame(
            'TEST',
            $this->runTwig(
                '{{ ["test"]|map(\'Cicada\\\\Tests\\\\Unit\\\\Core\\\\Framework\\\\Adapter\\\\Twig\\\\SecurityExtensionGoodClass::upper\')|join }}',
                ['Cicada\\Tests\\Unit\\Core\\Framework\\Adapter\\Twig\\SecurityExtensionGoodClass::upper'],
            )
        );
    }
