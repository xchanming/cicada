...
class DataAbstractionLayerExceptionTest extends TestCase
{
    ...
    public function testFkFieldByStorageNameNotFound66(): void
    {
        ...
        static::assertEquals(
            'Could not find FK field "taxId" from definition "Cicada\Core\Content\Product\ProductDefinition"',
            $e->getMessage()
        );
    }
    ...
    public function testFkFieldByStorageNameNotFound(): void
    {
        ...
        static::assertEquals(
            'Can not detect FK field with storage name taxId in definition Cicada\Core\Content\Product\ProductDefinition',
            $e->getMessage()
        );
    ...
    public function testLanguageFieldByStorageNameNotFound66(): void
    {
        ...
        static::assertEquals(
            'Could not find language field "taxId" in definition "Cicada\Core\Content\Product\ProductDefinition"',
            $e->getMessage()
        );
    }
    ...
    public function testLanguageFieldByStorageNameNotFound(): void
    {
        ...
        static::assertEquals(
            'Can not detect language field with storage name taxId in definition Cicada\Core\Content\Product\ProductDefinition',
            $e->getMessage()
        );
        static::assertEquals(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertEquals(DataAbstractionLayerException::REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND, $e->getErrorCode());
    ...
    public function testDefinitionFieldDoesNotExist66(): void
    {
        ...
        static::assertEquals(
            'Could not find reference field "taxId" from definition "Cicada\Core\Content\Product\ProductDefinition"',
            $e->getMessage()
        );
    }
    ...
    public function testDefinitionFieldDoesNotExist(): void
    {
        ...
        static::assertEquals(
            'Can not detect reference field with storage name taxId in definition Cicada\Core\Content\Product\ProductDefinition',
            $e->getMessage()
        );
        static::assertEquals(Response::HTTP_INTERNAL_SERVER_ERROR, $e->getStatusCode());
        static::assertEquals(DataAbstractionLayerException::REFERENCE_FIELD_BY_STORAGE_NAME_NOT_FOUND, $e->getErrorCode());
