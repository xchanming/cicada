...
class EntityDispatcherTest extends TestCase
{
    ...
    public function testAddsShopIdHeader(): void
    {
        $client = new MockHttpClient(function ($method, $url, $options): MockResponse {
            ...
            static::assertContains('Cicada-Shop-Id: shop-id', $headers);
    ...
    public function testAddsCicadaVersionToPayload(): void
    {
        $client = new MockHttpClient(function ($method, $url, $options): MockResponse {
            $body = gzdecode($options['body']);
            static::assertIsString($body);
            ...
            $payload = json_decode($body, true, flags: \JSON_THROW_ON_ERROR);
            static::assertArrayHasKey('cicada_version', $payload);
            static::assertSame('6.5.3.0', $payload['cicada_version']);
