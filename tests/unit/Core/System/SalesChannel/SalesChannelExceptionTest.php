...
class SalesChannelExceptionTest extends TestCase
{
    ...
    public function testExceptions(CicadaHttpException|SalesChannelException $exception, int $statusCode, string $errorCode, string $message): void
    {
    ...
    /**
     * @return array<string, array{exception: CicadaHttpException|SalesChannelException, statusCode: int, errorCode: string, message: string}>
     */
