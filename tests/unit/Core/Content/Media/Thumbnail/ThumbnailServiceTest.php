...
namespace Cicada\Tests\Unit\Core\Content\Media\Thumbnail;
...
use Cicada\Core\Content\Media\Thumbnail\ThumbnailSizeCalculator;
...
class ThumbnailServiceTest extends TestCase
{
    ...
    public function testGenerateWithValidMediaCollection(): void
    {
        ...
        $file = file_get_contents(__DIR__ . '/cicada-logo.png');
    ...
    private function createMediaEntity(MediaThumbnailEntity $mediaThumbnailEntity, MediaFolderEntity $mediaFolderEntity): MediaEntity
    {
        ...
        $mediaEntity->setFileName('cicada-logo');
        ...
        $mediaEntity->setPath(__DIR__ . '/cicada-logo.png');
        ...
        $mediaEntity->setUrl('/url/to/cicada-logo.png');
    ...
    private function createMediaThumbnailEntity(): MediaThumbnailEntity
    {
        ...
        $mediaThumbnailEntity->setPath(__DIR__ . '/cicada-logo.png');
