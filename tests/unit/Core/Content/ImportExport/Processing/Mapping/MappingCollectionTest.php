...
class MappingCollectionTest extends TestCase
{
    ...
    {
        $this->expectExceptionMessage('Expected collection element of type Cicada\Core\Content\ImportExport\Processing\Mapping\Mapping got Cicada\Core\Framework\Struct\ArrayEntity');
