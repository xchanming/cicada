...
use Cicada\Tests\Unit\Storefront\Theme\fixtures\ThemeNotIncludingPluginJsAndCss\ThemeNotIncludingPluginJsAndCss;
...
class ThemeFileResolverTest extends TestCase
{
    public function testResolvedFilesIncludeSkinScssPath(): void
    {
        ...
        $expected = '/Resources\/app\/storefront\/src\/scss\/skin\/cicada\/_base.scss';
    ...
    public function testResolvedFilesDoNotIncludeSkinScssPath(): void
    {
        ...
        $actual = json_encode($resolvedFiles, \JSON_PRETTY_PRINT);
        $notExpected = '/Resources\/app\/storefront\/src\/scss\/skin\/cicada\/_base.scss';
