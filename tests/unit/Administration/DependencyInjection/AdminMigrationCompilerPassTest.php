...
namespace Cicada\Tests\Unit\Administration\DependencyInjection;
...
class AdminMigrationCompilerPassTest extends TestCase
{
    public function testProcessing(): void
    {
        ...
        static::assertSame('Cicada\Administration\Migration\V6_4', $calls[0][1][1]);
        ...
        static::assertSame('Cicada\Administration\Migration\V6_6', $calls[0][1][1]);
    }
}
