...
use Cicada\Core\Migration\V6_3\Migration1565346846Promotion;
...
use Cicada\Core\Migration\V6_3\Migration1568901713PromotionDiscount;
...
class MigrationSourceTest extends TestCase
{
    ...
    {
        $pattern = static::getContainer()->get('Cicada\Core\Framework\Migration\MigrationSource.core.V6_3')->getNamespacePattern();
    ...
    public static function provideCoreRegexDataV6_3(): array
    {
        $cases = [
            ...
            ['Cicada\Core\Migration\V6_3\Something\Migration1571059598ChangeGreatBritainToUnitedKingdom', false],
        ];
    ...
    public static function provideUnitTestData(): array
    {
        return [
            ['__NOPE__', false],
            ['Cicada\Storefront\Migration\Migration1572858066UpdateDefaultCategorySeoUrlTemplate', false],
