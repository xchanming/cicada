...
---
# Core
* Added `\Cicada\Core\Content\Product\SalesChannel\Listing\FilterCollection`, which contains all filter definitions for a listing
* Added `\Cicada\Core\Content\Product\SalesChannel\Listing\Filter`, which contains all meta information about a listing filter
* Added `\Cicada\Core\Content\Product\Events\ProductListingCollectFilterEvent`, which allows to simply add new filters for listing
___
# Upgrade Information
