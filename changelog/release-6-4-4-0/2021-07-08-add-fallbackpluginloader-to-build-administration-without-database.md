...
---
# Core
* Added new class `\Cicada\Core\Framework\Plugin\KernelPluginLoader\ComposerPluginLoader` to load plugins from composer without database instead
* Deprecated class `\Cicada\Core\Framework\Plugin\BundleConfigDumper`, use `\Cicada\Core\Framework\Plugin\BundleConfigGenerator` instead
___
# Upgrade Information
