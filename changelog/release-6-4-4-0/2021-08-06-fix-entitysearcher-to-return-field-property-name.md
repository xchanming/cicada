...
---
# Core
* Changed \Cicada\Core\Framework\DataAbstractionLayer\Dbal\EntitySearcher::search to return IdsSearchResult with fields's property name instead of storage name
___
# Upgrade Information
