...
* Removed class `Cicada\Core\Checkout\Cart\Price\ReferencePriceCalculator`
...
* Removed class `Cicada\Core\Framework\DataAbstractionLayer\Dbal\JoinBuilder\AntiJoinBuilder`
...
* Removed method `Cicada\Core\Checkout\Order\Aggregate\OrderTransaction\OrderTransactionEntity::getApiAlias`
...
* Removed method `Cicada\Core\Content\ImportExport\Aggregate\ImportExportLog\ImportExportLogEntity::getApiAlias`
...
* Removed method `Cicada\Core\Content\Product\ProductEntity::setPurchasePrice`
...
* Removed method `Cicada\Core\Framework\DataAbstractionLayer\Dbal\FieldResolver\OneToManyAssociationFieldResolver::resolve`
...
* Removed method `Cicada\Core\System\Locale\LocaleEntity::getApiAlias`
...
* Removed parameter `$calculated` from method `Cicada\Core\Checkout\Cart\CustomCartProcessor::process`
...
* Removed parameter `$requestCriteriaBuilder` from method `Cicada\Core\Checkout\Order\SalesChannel\OrderRoute::__construct`
...
* Removed parameter `$requestActiveId` from method `Cicada\Core\Content\Category\SalesChannel\NavigationRoute::load`
...
* Removed parameter `$definition` from method `Cicada\Core\Content\Product\SalesChannel\Suggest\ProductSuggestRoute::__construct`
...
* Removed parameter `$apiVersion` from method `Cicada\Core\Framework\Api\Serializer\JsonApiEncodingResult::__construct`
...
* Removed parameter `$languageId` from method `Cicada\Core\System\SalesChannel\Context\SalesChannelContextServiceInterface::get`
...
* Changed parameter `$restockTime` type from `int` to `?int` of method `Cicada\Core\Content\Product\ProductEntity::setRestockTime`
...
* Changed parameter `$routes` type from `RouteCollectionBuilder` to `RoutingConfigurator` of method `Cicada\Core\Framework\Bundle::configureRouteOverwrites`
* Changed parameter `$generators` type from `iterable` to `IteratorAggregate` of method `Cicada\Core\Framework\Demodata\DemodataService::__construct`
* Changed parameter `$contextFactory` type from `SalesChannelContextFactory` to `AbstractSalesChannelContextFactory` of method `Cicada\Core\Framework\Demodata\Generator\OrderGenerator::__construct`
* Changed parameter `$routes` type from `RouteCollectionBuilder` to `RoutingConfigurator` of method `Cicada\Core\Framework\Plugin::configureRoutes`
* Changed parameter `$location` type from `string` to `PluginDownloadDataStruct` of method `Cicada\Core\Framework\Plugin\PluginManagementService::downloadStorePlugin`
* Changed parameter `$region` type from `string` to `?string` of method `Cicada\Core\Framework\Store\Services\FirstRunWizardClient::getRecommendations`
* Changed parameter `$routes` type from `RouteCollectionBuilder` to `RoutingConfigurator` of method `Cicada\Core\Kernel::configureRoutes`
* Changed parameter `$exception` type from `?Exception` to `?Throwable` of method `Cicada\Core\Profiling\Doctrine\ConnectionProfiler::collect`
* Changed parameter `$criteria` type from `?Criteria` to `Criteria` of method `Cicada\Core\System\Currency\SalesChannel\CurrencyRoute::load`
* Changed parameter `$criteria` type from `?Criteria` to `Criteria` of method `Cicada\Core\System\Language\SalesChannel\LanguageRoute::load`
* Changed parameter `$languages` type from `LanguageCollection` to `EntitySearchResult` of method `Cicada\Core\System\Language\SalesChannel\LanguageRouteResponse::__construct`
* Changed parameter `$pattern` type from `string` to `?string` of method `Cicada\Core\System\NumberRange\ValueGenerator\NumberRangeValueGenerator::previewPattern`
* Changed parameter `$pattern` type from `string` to `?string` of method `Cicada\Core\System\NumberRange\ValueGenerator\NumberRangeValueGenerator::createPreviewConfiguration`
* Changed parameter `$pattern` type from `string` to `?string` of method `Cicada\Core\System\NumberRange\ValueGenerator\NumberRangeValueGeneratorInterface::previewPattern`
* Changed parameter `$factory` type from `SalesChannelContextFactory` to `AbstractSalesChannelContextFactory` of method `Cicada\Core\System\SalesChannel\Context\SalesChannelContextService::__construct`
* Changed parameter `$criteria` type from `?Criteria` to `Criteria` of method `Cicada\Core\System\Salutation\SalesChannel\SalutationRoute::load`
* Changed parameter `$userRepository` type from `EntityRepository` to `EntityRepositoryInterface` of method `Cicada\Core\System\User\Command\UserChangePasswordCommand::__construct`
* Changed return type for method `Cicada\Core\Checkout\Cart\CartValueResolver::resolve` from `iterable` to `Generator`
* Changed return type for method `Cicada\Core\Checkout\Cart\Event\CartDeletedEvent::getContext` from `SalesChannelContext` to `Context`
* Changed return type for method `Cicada\Core\Checkout\Cart\Event\CheckoutOrderPlacedEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Checkout\Cart\Event\LineItemRemovedEvent::getContext` from `SalesChannelContext` to `Context`
* Changed return type for method `Cicada\Core\Checkout\Cart\Rule\LineItemRule::getIdentifiers` from `array` to `?array`
* Changed return type for method `Cicada\Core\Checkout\Customer\Event\CustomerAccountRecoverRequestEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Checkout\Customer\Event\CustomerDoubleOptInRegistrationEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Checkout\Customer\Event\CustomerRegisterEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Checkout\Customer\Event\DoubleOptInGuestOrderEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Checkout\Customer\SalesChannel\AbstractChangePasswordRoute::change` from `SuccessResponse` to `ContextTokenResponse`
* Changed return type for method `Cicada\Core\Checkout\Customer\SalesChannel\AbstractLogoutRoute::logout` from `NoContentResponse` to `ContextTokenResponse`
* Changed return type for method `Cicada\Core\Checkout\Customer\SalesChannel\ChangePasswordRoute::change` from `SuccessResponse` to `ContextTokenResponse`
* Changed return type for method `Cicada\Core\Checkout\Customer\SalesChannel\LogoutRoute::logout` from `NoContentResponse` to `ContextTokenResponse`
* Changed return type for method `Cicada\Core\Checkout\Order\Event\OrderStateMachineStateChangeEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Checkout\Order\OrderEntity::getOrderNumber` from `string` to `?string`
* Changed return type for method `Cicada\Core\Checkout\Promotion\PromotionEntity::getMaxRedemptionsGlobal` from `int` to `?int`
* Changed return type for method `Cicada\Core\Checkout\Promotion\PromotionEntity::getMaxRedemptionsPerCustomer` from `int` to `?int`
* Changed return type for method `Cicada\Core\Content\Cms\CmsPageEntity::getEntity` from `string` to `?string`
* Changed return type for method `Cicada\Core\Content\ImportExport\ImportExportProfileEntity::getName` from `string` to `?string`
* Changed return type for method `Cicada\Core\Content\MailTemplate\Service\Event\MailBeforeSentEvent::getMessage` from `Swift_Message` to `Email`
* Changed return type for method `Cicada\Core\Content\Newsletter\Event\NewsletterConfirmEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Content\Newsletter\Event\NewsletterRegisterEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Content\Newsletter\Event\NewsletterUpdateEvent::getSalesChannelId` from `?string` to `string`
* Changed return type for method `Cicada\Core\Content\Product\Aggregate\ProductConfiguratorSetting\ProductConfiguratorSettingEntity::getMediaId` from `string` to `?string`
* Changed return type for method `Cicada\Core\Content\Product\Aggregate\ProductReview\ProductReviewEntity::getCustomerId` from `string` to `?string`
* Changed return type for method `Cicada\Core\Content\Product\ProductEntity::getRestockTime` from `int` to `?int`
* Changed return type for method `Cicada\Core\Content\Property\Aggregate\PropertyGroupOption\PropertyGroupOptionEntity::getPosition` from `int` to `?int`
* Changed return type for method `Cicada\Core\Content\Sitemap\Commands\SitemapGenerateCommand::execute` from `?int` to `int`
* Changed return type for method `Cicada\Core\Framework\Api\Context\ContextValueResolver::resolve` from `iterable` to `Generator`
* Changed return type for method `Cicada\Core\Framework\Api\Converter\ConverterRegistry::getConverters` from `array` to `iterable`
* Changed return type for method `Cicada\Core\Framework\Api\Response\ResponseFactoryInterfaceValueResolver::resolve` from `iterable` to `Generator`
* Changed return type for method `Cicada\Core\Framework\DataAbstractionLayer\Version\Aggregate\VersionCommit\VersionCommitEntity::getVersionId` from `string` to `?string`
* Changed return type for method `Cicada\Core\Framework\Plugin\PluginManagementService::extractPluginZip` from `void` to `string`
* Changed return type for method `Cicada\Core\Framework\Routing\Annotation\CriteriaValueResolver::resolve` from `iterable` to `Generator`
* Changed return type for method `Cicada\Core\System\SalesChannel\Context\SalesChannelContextValueResolver::resolve` from `iterable` to `Generator`
* Removed return type `FieldResolverInterface` for method `Cicada\Core\Framework\DataAbstractionLayer\DefinitionInstanceRegistry::getResolver`
* Removed return type `?FieldResolverInterface` for method `Cicada\Core\Framework\DataAbstractionLayer\Field\Field::getResolver`
...
___
# Elasticsearch
* Removed class `Cicada\Elasticsearch\Framework\FullText`
...
* Removed method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::getName`
* Removed method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::update`
* Removed method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::sendIndexingMessages`
* Removed method `Cicada\Elasticsearch\Product\ElasticsearchProductDefinition::extendCriteria`
* Removed parameter `$entityRegistry` from method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::__construct`
* Removed parameter `$messageBus` from method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::__construct`
* Removed parameter `$cacheClearer` from method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::__construct`
* Changed parameter `$indexer` type from `EntityIndexerRegistry` to `ElasticsearchIndexer` of method `Cicada\Elasticsearch\Framework\Command\ElasticsearchIndexingCommand::__construct`
* Removed type `EntityIndexingMessage` from parameter `$message` of method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::handle`
* Changed return type for method `Cicada\Elasticsearch\Framework\DataAbstractionLayer\CriteriaParser::parseTermsAggregation` from `CompositeAggregation` to `AbstractAggregation`
* Changed return type for method `Cicada\Elasticsearch\Framework\Indexing\ElasticsearchIndexer::iterate` from `?EntityIndexingMessage` to `?ElasticsearchIndexingMessage`
* Changed return type for method `Cicada\Elasticsearch\Framework\Indexing\IndexerOffset::setNextLanguage` from `string` to `?string`
* Changed return type for method `Cicada\Elasticsearch\Framework\Indexing\IndexerOffset::getLanguageId` from `string` to `?string`
* Changed return type for method `Cicada\Elasticsearch\Framework\Indexing\IndexerOffset::getDefinition` from `string` to `?string`
* Bumped up dependency `doctrine/dbal` from version `2.10.1` to version `2.12.1`
...
___
# Storefront
* Removed class `Cicada\Storefront\Framework\Cache\CacheTagCollection`
* Removed class `Cicada\Storefront\Framework\Cache\ObjectCacheKeyFinder`
* Removed class `Cicada\Storefront\Migration\Migration1536232990SeoUrl`
* Removed class `Cicada\Storefront\Migration\Migration1551969523SeoUrlTemplate`
* Removed class `Cicada\Storefront\Migration\Migration1568787535AddSeoUrlConstraints`
* Removed class `Cicada\Storefront\Migration\Migration1569907970RemoveUnusedSeoColumns`
* Removed class `Cicada\Storefront\Migration\Migration1572858066UpdateDefaultCategorySeoUrlTemplate`
* Removed class `Cicada\Storefront\Migration\Migration1574258786SeoUrlLanguageKeyCascade`
* Removed class `Cicada\Storefront\Page\Product\CrossSelling\CrossSellingLoader`
* Removed class `Cicada\Storefront\Page\Product\CrossSelling\CrossSellingProductListCriteriaEvent`
* Removed class `Cicada\Storefront\Page\Product\CrossSelling\CrossSellingProductStreamCriteriaEvent`
* Removed class `Cicada\Storefront\Page\Product\ProductLoader`
* Removed method `Cicada\Storefront\Controller\CsrfController::getApiAccess`
* Removed method `Cicada\Storefront\Controller\StorefrontController::denyAccessUnlessLoggedIn`
* Removed method `Cicada\Storefront\Framework\Twig\TemplateDataExtension::getThemeConfig`
* Removed method `Cicada\Storefront\Page\Checkout\Confirm\CheckoutConfirmPage::__construct`
* Removed method `Cicada\Storefront\Page\Product\Configurator\AvailableCombinationResult::hasCombination`
* Removed method `Cicada\Storefront\Page\Product\Configurator\AvailableCombinationResult::addCombination`
* Removed method `Cicada\Storefront\Page\Product\Configurator\AvailableCombinationResult::hasOptionId`
* Removed method `Cicada\Storefront\Page\Product\Configurator\AvailableCombinationResult::getHashes`
* Removed method `Cicada\Storefront\Page\Product\Review\RatingMatrix::getTotalPoints`
* Removed method `Cicada\Storefront\Theme\Controller\ThemeController::fields`
* Removed method `Cicada\Storefront\Theme\StorefrontPluginConfiguration\StorefrontPluginConfiguration::setTechnicalName`
* Removed method `Cicada\Storefront\Theme\StorefrontPluginConfiguration\StorefrontPluginConfigurationFactory::createPluginConfig`
* Removed method `Cicada\Storefront\Theme\StorefrontPluginConfiguration\StorefrontPluginConfigurationFactory::createThemeConfig`
* Removed method `Cicada\Storefront\Theme\ThemeService::getResolvedThemeConfiguration`
* Removed method `Cicada\Storefront\Theme\ThemeService::getThemeConfigurationFields`
* Removed parameter `$orderRoute` from method `Cicada\Storefront\Controller\AccountOrderController::__construct`
* Removed parameter `$addressService` from method `Cicada\Storefront\Controller\AddressController::__construct`
* Removed parameter `$systemConfig` from method `Cicada\Storefront\Controller\AuthController::__construct`
* Removed parameter `$orderRepository` from method `Cicada\Storefront\Controller\CheckoutController::__construct`
* Removed parameter `$flashBag` from method `Cicada\Storefront\Controller\ErrorController::__construct`
* Removed parameter `$productReviewService` from method `Cicada\Storefront\Controller\ProductController::__construct`
* Removed parameter `$accountService` from method `Cicada\Storefront\Controller\RegisterController::__construct`
* Removed parameter `$accountRegistrationService` from method `Cicada\Storefront\Controller\RegisterController::__construct`
* Removed parameter `$cacheTagCollection` from method `Cicada\Storefront\Framework\Cache\CacheStore::__construct`
* Removed parameter `$connection` from method `Cicada\Storefront\Framework\Routing\RequestTransformer::__construct`
* Removed parameter `$cache` from method `Cicada\Storefront\Framework\Routing\RequestTransformer::__construct`
* Removed parameter `$cacheKeyGenerator` from method `Cicada\Storefront\Framework\Routing\RequestTransformer::__construct`
* Removed parameter `$event` from method `Cicada\Storefront\Framework\Routing\StorefrontSubscriber::updateSession`
* Removed parameter `$systemConfigService` from method `Cicada\Storefront\Framework\Twig\TemplateDataExtension::__construct`
* Removed parameter `$themeService` from method `Cicada\Storefront\Framework\Twig\TemplateDataExtension::__construct`
* Removed parameter `$countryRepository` from method `Cicada\Storefront\Page\Account\Login\AccountLoginPageLoader::__construct`
* Removed parameter `$salutationRepository` from method `Cicada\Storefront\Page\Account\Login\AccountLoginPageLoader::__construct`
* Removed parameter `$paymentMethodRoute` from method `Cicada\Storefront\Page\Account\PaymentMethod\AccountPaymentMethodPageLoader::__construct`
* Removed parameter `$countryRepository` from method `Cicada\Storefront\Page\Address\Detail\AddressDetailPageLoader::__construct`
* Removed parameter `$salutationRepository` from method `Cicada\Storefront\Page\Address\Detail\AddressDetailPageLoader::__construct`
* Removed parameter `$addressService` from method `Cicada\Storefront\Page\Address\Detail\AddressDetailPageLoader::__construct`
* Removed parameter `$countryRepository` from method `Cicada\Storefront\Page\Address\Listing\AddressListingPageLoader::__construct`
* Removed parameter `$salutationRepository` from method `Cicada\Storefront\Page\Address\Listing\AddressListingPageLoader::__construct`
* Removed parameter `$addressRepository` from method `Cicada\Storefront\Page\Address\Listing\AddressListingPageLoader::__construct`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Page\Checkout\Confirm\CheckoutConfirmPageLoader::load`
* Removed parameter `$addressService` from method `Cicada\Storefront\Page\Checkout\Register\CheckoutRegisterPageLoader::__construct`
* Removed parameter `$salutationRepository` from method `Cicada\Storefront\Page\Checkout\Register\CheckoutRegisterPageLoader::__construct`
* Removed parameter `$countryRepository` from method `Cicada\Storefront\Page\Checkout\Register\CheckoutRegisterPageLoader::__construct`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Page\GenericPageLoaderInterface::load`
* Removed parameter `$connection` from method `Cicada\Storefront\Page\Product\Configurator\AvailableCombinationLoader::__construct`
* Removed parameter `$configuratorRepository` from method `Cicada\Storefront\Page\Product\Configurator\ProductPageConfiguratorLoader::__construct`
* Removed parameter `$combinationLoader` from method `Cicada\Storefront\Page\Product\Configurator\ProductPageConfiguratorLoader::__construct`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Page\Product\Configurator\ProductPageConfiguratorLoader::load`
* Removed parameter `$productRepository` from method `Cicada\Storefront\Page\Product\ProductPageLoader::__construct`
* Removed parameter `$configuratorLoader` from method `Cicada\Storefront\Page\Product\ProductPageLoader::__construct`
* Removed parameter `$productLoader` from method `Cicada\Storefront\Page\Product\ProductPageLoader::__construct`
* Removed parameter `$crossSellingLoader` from method `Cicada\Storefront\Page\Product\ProductPageLoader::__construct`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Page\Product\ProductPageLoader::load`
* Removed parameter `$productLoader` from method `Cicada\Storefront\Page\Product\QuickView\MinimalQuickViewPageLoader::__construct`
* Removed parameter `$reviewRepository` from method `Cicada\Storefront\Page\Product\Review\ProductReviewLoader::__construct`
* Removed parameter `$sitemapLister` from method `Cicada\Storefront\Page\Sitemap\SitemapPageLoader::__construct`
* Removed parameter `$sitemapExporter` from method `Cicada\Storefront\Page\Sitemap\SitemapPageLoader::__construct`
* Removed parameter `$systemConfigService` from method `Cicada\Storefront\Page\Sitemap\SitemapPageLoader::__construct`
* Removed parameter `$session` from method `Cicada\Storefront\Page\Sitemap\SitemapPageLoader::__construct`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Page\Sitemap\SitemapPageLoader::load`
* Removed parameter `$requestCriteriaBuilder` from method `Cicada\Storefront\Pagelet\Header\HeaderPageletLoader::__construct`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Pagelet\Header\HeaderPageletLoaderInterface::load`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Pagelet\Menu\Offcanvas\MenuOffcanvasPageletLoader::load`
* Removed parameter `$salesChannelContext` from method `Cicada\Storefront\Pagelet\Menu\Offcanvas\MenuOffcanvasPageletLoaderInterface::load`
* Removed parameter `$cacheDir` from method `Cicada\Storefront\Theme\Command\ThemeDumpCommand::__construct`
* Removed parameter `$cacheClearer` from method `Cicada\Storefront\Theme\ThemeCompiler::__construct`
* Removed parameter `$mediaRepository` from method `Cicada\Storefront\Theme\ThemeService::__construct`
* Removed parameter `$kernel` from method `Cicada\Storefront\Theme\Twig\ThemeInheritanceBuilder::__construct`
* Changed parameter `$id` type from `string` to `?string` of method `Cicada\Storefront\Controller\CmsController::page`
* Changed parameter `$navigationId` type from `string` to `?string` of method `Cicada\Storefront\Controller\CmsController::category`
* Changed parameter `$resolver` type from `SeoResolverInterface` to `AbstractSeoResolver` of method `Cicada\Storefront\Framework\Routing\RequestTransformer::__construct`
* Changed parameter `$twig` type from `Twig_Environment` to `Environment` of method `Cicada\Storefront\Framework\Twig\TwigDateRequestListener::__construct`
* Changed parameter `$wishedGroupId` type from `string` to `?string` of method `Cicada\Storefront\Page\Product\Configurator\ProductCombinationFinder::find`
* Changed parameter `$crossSellings` type from `CrossSellingLoaderResult` to `CrossSellingElementCollection` of method `Cicada\Storefront\Page\Product\ProductPage::setCrossSellings`
* Changed parameter `$pluginConfigurationFactory` type from `StorefrontPluginConfigurationFactory` to `AbstractStorefrontPluginConfigurationFactory` of method `Cicada\Storefront\Theme\StorefrontPluginRegistry::__construct`
* Changed parameter `$pluginConfigurationFactory` type from `StorefrontPluginConfigurationFactory` to `AbstractStorefrontPluginConfigurationFactory` of method `Cicada\Storefront\Theme\Subscriber\PluginLifecycleSubscriber::__construct`
* Changed parameter `$themeRegistry` type from `?StorefrontPluginRegistryInterface` to `StorefrontPluginRegistryInterface` of method `Cicada\Storefront\Theme\Twig\ThemeInheritanceBuilder::__construct`
* Changed return type for method `Cicada\Storefront\Page\Product\ProductPage::getCrossSellings` from `CrossSellingLoaderResult` to `CrossSellingElementCollection`
* Changed return type for method `Cicada\Storefront\Theme\StorefrontPluginConfiguration\StorefrontPluginConfiguration::getTechnicalName` from `?string` to `string`
...
* Bumped up dependency `twig/twig` from version `2.12.3` to version `3.3.0`
* Dropped npm package `node-sass`.
* Bumped up npm package `@cicada-ag/webpack-plugin-injector` from version `1.0.5` to version `1.0.6`.
* Bumped up npm package `copy-webpack-plugin` from version `5.1.1` to version `6.4.1`.
* Bumped up npm package `eslint` from version `5.16.0` to version `7.10.0`.
