...
Currently, to define a custom sorting option, you need to define it as a service and tag it as `cicada.sales_channel.product_listing.sorting`.
...
namespace Cicada\Core\Content\Product\SalesChannel\Sorting\Example;
