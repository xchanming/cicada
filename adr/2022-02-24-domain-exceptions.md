...
Until now, we have implemented many different exception classes in Cicada to map different exception cases. 
...
namespace Cicada\Core\Content\Product {
    ...
    class ProductException extends CicadaHttpException
    {
        public static function notFound(?\Throwable $e = null): void
        {
